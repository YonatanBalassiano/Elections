...
bin/cRace customTests/output1.json
bin/cRace customTests/output2.json
bin/cRace customTests/output3.json
...
diff -s customTests/output1_sol.out customTests/output1.out
diff -s customTests/output2_sol.out customTests/output2.out
diff -s customTests/output3_sol.out customTests/output3.out
